...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
    <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6" href="#">Face Recognition</a>
        ...
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
            <div class="position-sticky pt-3 sidebar-sticky">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('authorized.index')}}">
                            <i class="bi bi-people"></i>
                            View Users
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('authorized.create')}}">
                            <i class="bi bi-person-add"></i>
                            New Face
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('attempts.index')}}">
